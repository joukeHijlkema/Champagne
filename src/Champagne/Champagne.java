...
//    this.setSize(1208, 808);
  ...
  private void initComponents() {
    ...
    eleveTabLayout.setHorizontalGroup(
      ...
      .addGroup(eleveTabLayout.createSequentialGroup()
        .addContainerGap()
        .addGroup(eleveTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
  ...
  private void savePdfButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savePdfButtonActionPerformed
    Bulletin3 b = new Bulletin3(this.getPeriode(), scale.getValue(), myDB);
    b.makePDF();
    ...
    if (this.pickFile.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
      b.Save(this.pickFile.getSelectedFile().getAbsolutePath());
    }
  ...
  private void updateAll() {
    ...
    this.Adresse.setText(this.myDB.ECOLE);
  ...
  private void addMod(String what) {
    switch (what) {
      ...
      case "Periode":
        ...
        myDB.addPeriode(new Periode(0, this.actualYear, this.actualTrim));
        break;
      case "Eleve":
